...
class fan_toggle(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.f_carrier = f_carrier = 350000
        self.toggle = toggle = 0
        self.samp_rate = samp_rate = f_carrier*3
        ...
        self._toggle_range = qtgui.Range(0, 1, 1, 0, 200)
        self._toggle_win = qtgui.RangeWidget(self._toggle_range, self.set_toggle, "'toggle'", "slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._toggle_win)
        ...
        self.digital_map_bb_0 = digital.map_bb([3, 1])
        ...
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_char*1, (int(samp_rate*9)))
    ...
    def set_f_carrier(self, f_carrier):
        ...
        self.set_samp_rate(self.f_carrier*3)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_repeat_0.set_interpolation((int(self.samp_rate*9)))
