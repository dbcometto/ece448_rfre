...
class fan_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fan_test")
        ...
        self.uhd_usrp_sink_0.set_center_freq(349000000, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\workspace\\ece448_rfre\\data\\light_toggle_data.grc', True, 0, 0)
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.uhd_usrp_sink_0, 0))
...
def main(top_block_cls=fan_test, options=None):
